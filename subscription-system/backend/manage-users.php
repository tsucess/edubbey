    ...
    <?php require './template/sidebar.php'; ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h2>Manage Users</h2> <a href="add-user.php" class="btn btn-success">Add User</a>
                </div>
                ...
                <div class="table-responsive">
                        ...
                        <?php if (mysqli_num_rows($users) > 0) : ?>
                                <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                                  <tr>
                                    ...
                                    <td><?= $user['email'] ?></td>        
                                    <td><a href="<?= ROOT_URL ?>backend/view-profile.php?id=<?= $user['id'] ?>"  class="btn btn-submit">View</a></td>
                    ...
                    <?php else :  ?>
                        <tr>
                            <td colspan="5" class="text-center p-2"> No Users data</td>
                        </tr>
                    <?php endif  ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="edit-user-modal" enctype="multipart/form-data">
                  ...
                  <button class="w-100 btn btn-lg btn-primary update-user-btn" type="submit">Update User Profile </button>
            </form>
        </div>
      </div>
    </div>
